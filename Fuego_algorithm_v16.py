...
#                            plt.title(top_gr)
    ...
    #%%
            ...
            # 3 = seismic detection only - made with Ground Coupled Airwave
            # 10 = Gas Burst During Tremor
            # 20 = Ash Burst During Tremor
...
#%% Remove less than 3 detections if 3+ stations running
        ...
        for b in range(len(Day_catalogue),0,-1):
            ...
            if (detec < 3) and (len(station_activity) > 3) :
...
np.savetxt("/Users/william/Documents/Fuego_catalogue/Fuego_scan_v14.csv", final_ordered,delimiter=",",header="Time_stamp,Year,Month,Day,Hour,Min,Sec,Event_type_ID,Duration [s],#inf,#seis,#Stations,VF01,VF02,VF03,VF04,VF05,VF06,FG8A,FG8B,FG8C,FG10A,FG10B,FG10C,FG11A,FG11B,FG11C,FG11D,FG12A,FG12B,FG12C,FG13A,FG13B,FG13C,FG15A,FG15B,FG15C,FG15D,FG15E,FG15F,FV01,FV02,FV03,FV04,FV08,FG3S,FG8S,FG10S,FG11S,FG12S,FG13S,FG14S,FG16S")
